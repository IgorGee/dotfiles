...
plugins=(git npm node python react-native yarn)
...
alias psi='sudo prime-select intel && reboot'
alias psn='sudo prime-select nvidia && reboot'
alias psq='sudo prime-select query'
